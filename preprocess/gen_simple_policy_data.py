...
output_dir = os.path.join(code_dir, 'data/peract/train_dataset/keysteps_bbox_pcd/seed0/voxel1cm')
taskvar_file = os.path.join(code_dir, 'assets', 'taskvars_peract.json')
