...
from genrobo3d.train.datasets.motion_planner_dataset_augment import (
    MotionPlannerDatasetAugment, base_collate_fn_partial, ptv3_collate_fn_partial
)
...
DATASET_FACTORY = {
    'MotionPlannerPTV3AdaNorm': (MotionPlannerDatasetAugment, ptv3_collate_fn_partial),
    'MotionPlannerPTV3CA':  (MotionPlannerDatasetAugment, ptv3_collate_fn_partial)
}
