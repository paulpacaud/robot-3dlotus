...
from genrobo3d.train.datasets.motion_planner_dataset_peract import (
    MotionPlannerDatasetPerAct, base_collate_fn_partial, ptv3_collate_fn_partial
)
...
DATASET_FACTORY = {
    'MotionPlannerPTV3AdaNorm': (MotionPlannerDatasetPerAct, ptv3_collate_fn_partial),
    'MotionPlannerPTV3CA':  (MotionPlannerDatasetPerAct, ptv3_collate_fn_partial)
}
