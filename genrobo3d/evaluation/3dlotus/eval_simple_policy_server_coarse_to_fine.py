...
from genrobo3d.evaluation.eval_simple_policy_coarse_to_fine import Actioner
...
def main():
    ...
    args.exp_config_coarse = os.path.join(args.coarse_model_dir, 'logs', 'training_config.yaml')
    args.checkpoint_coarse = os.path.join(args.coarse_model_dir, 'ckpts', f'model_step_{args.ckpt_step_coarse}.pt')
