...
from genrobo3d.evaluation.robot_pipeline.robot_pipeline_gt_coarse_to_fine import (
...
def consumer_fn(
    args, pipeline_config, coarse_pipeline_config, batch_queue, result_queues
):
