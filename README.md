...
> RESULTS
```bash
python scripts/peract/summarize_results.py data/experiments/peract/3dlotusplus/v2_mix/preds-llm_gt-og_gt_mix-runstep1-maxsteps25/seed200/results.jsonl
