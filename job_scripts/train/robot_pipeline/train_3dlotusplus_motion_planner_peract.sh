...
srun python genrobo3d/train/train_motion_planner_peract.py \
    ...
    TRAIN_DATASET.taskvar_file assets/peract/taskvars_train_peract.json VAL_DATASET.taskvar_file assets/peract/taskvars_train_peract.json \
    TRAIN_DATASET.gt_act_obj_label_file assets/peract/taskvars_target_label_zrange_peract.json \
    VAL_DATASET.gt_act_obj_label_file assets/peract/taskvars_target_label_zrange_peract.json \
