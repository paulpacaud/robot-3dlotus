...
# gripper pose augmentation hyperparameters
noise_range=0.15
sampling_ratio=0.5
safe_distance=0.04
restart_pose=False

output_dir=data/experiments/gembench/3dlotusplus/v1_augment_noise_range${noise_range}_sampling_ratio${sampling_ratio}_safe_distance${safe_distance}_restartpose${restart_pose}
...
srun python genrobo3d/train/train_motion_planner_augment.py \
    --exp-config genrobo3d/configs/rlbench/motion_planner_ptv3_augment.yaml \
    ...
    TRAIN_DATASET.gt_act_obj_label_file assets/gembench/taskvars_target_label_zrange.json \
    VAL_DATASET.gt_act_obj_label_file assets/gembench/taskvars_target_label_zrange.json \
    ...
    TRAIN_DATASET.noise_range ${noise_range} TRAIN_DATASET.sampling_ratio ${sampling_ratio} \
    TRAIN_DATASET.safe_distance ${safe_distance} TRAIN_DATASET.restart_pose ${restart_pose}
