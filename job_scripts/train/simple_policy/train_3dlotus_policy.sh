...
output_dir=data/experiments/gembench/3dlotus/v1_voxel0.5_posbinsize0.01_zoom0.3
...
srun python genrobo3d/train/train_simple_policy.py \
    ...
    TRAIN_DATASET.data_dir data/gembench/train_dataset/keysteps_bbox_pcd/seed0/voxel0.5cm_zoom0.3 \
    VAL_DATASET.data_dir data/gembench/val_dataset/keysteps_bbox_pcd/seed100/voxel0.5cm_zoom0.3 \
