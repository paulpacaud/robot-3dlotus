...
output_dir=data/experiments/gembench/3dlotus/v1_voxel0.5cm_refine_zoom0.4_noise0.02

rot_type=euler_disc
npoints=4096
pos_bin_size=15

srun python genrobo3d/train/train_simple_policy_ctf.py \
    ...
    TRAIN_DATASET.taskvar_file assets/gembench/taskvars_train.json VAL_DATASET.taskvar_file assets/gembench/taskvars_train.json \
    TRAIN_DATASET.data_dir data/gembench/train_dataset/keysteps_bbox_pcd/seed0/voxel0.5cm_refine_zoom0.4_noise0.02 \
    VAL_DATASET.data_dir data/gembench/val_dataset/keysteps_bbox_pcd/seed100/voxel0.5cm_refine_zoom0.4_noise0.02 \
